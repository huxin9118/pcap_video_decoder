...
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeBackSDLThread(JNIEnv* env, jclass jcls)
{
	thread_back = 1;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativePauseSDLThread(JNIEnv* env, jclass jcls)
{
	thread_pause = 1;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativePlaySDLThread(JNIEnv* env, jclass jcls)
{
	thread_pause = 0;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeZoomSDLThread(JNIEnv* env, jclass jcls, jint jzoom)
{
	LOGI("zoom：%d",jzoom);
	updateSdlRect(jzoom);
	zoom = jzoom;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeForwardSDLThread(JNIEnv* env, jclass jcls, jlong jskipFrame)
{
	thread_forward = 1;
	is_Locating_I = 1;
	skipFrame = jskipFrame;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeBackwardSDLThread(JNIEnv* env, jclass jcls, jlong jskipFrame)
{
	thread_backward = 1;
	is_Locating_I = 1;
	skipFrame = jskipFrame;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeSeekSDLThread(JNIEnv* env, jclass jcls, jlong jseekFrame)
{
	thread_Seek = 1;
	is_Locating_I = 1;
	seekFrame = jseekFrame;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativePictureSDLThread(JNIEnv* env, jclass jcls)
{
	thread_picture=1;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeStartVideoSDLThread(JNIEnv* env, jclass jcls)
{
	thread_video=1;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeEndVideoSDLThread(JNIEnv* env, jclass jcls)
{
	thread_video=3;
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeCodecType(JNIEnv* env, jclass jcls, jint jcodec_type)
{
	thread_codec_type=jcodec_type;
	LOGI("thread_codec_type = %d",thread_codec_type);
}
JNIEXPORT void JNICALL Java_com_example_pcapdecoder_activity_SDLActivity_nativeUpdateSdlRect(JNIEnv* env, jclass jcls, jint jscreen_w, jint jscreen_h)
{
	screen_w = jscreen_w;
	screen_h = jscreen_h;
	updateSdlRect(zoom);
...
int main(JNIEnv* env,int argc, char* argv[])
{
	...
	if(argc == 5)
	{
		...
		jclass objcetClass = (*env)->FindClass(env,"com/example/pcapdecoder/activity/SDLActivity");
...
//------------Mediacodec init----------------		
		...
		// mediacodecContext.class_Codec = (*env)->FindClass(env, "com/example/pcapdecoder/mediacodec/Codec");
		// mediacodecContext.class_H264Decoder = (*env)->FindClass(env, "com/example/pcapdecoder/mediacodec/H264Decoder");
		// mediacodecContext.class_HH264Decoder = (*env)->FindClass(env, "com/example/pcapdecoder/mediacodec/HH264Decoder");
		// mediacodecContext.class_H264Utils = (*env)->FindClass(env, "com/example/pcapdecoder/mediacodec/H264Utils");
					...
					if(av_read_frame(pFormatCtx, packet)>=0)
					{
						if(packet->stream_index==videoindex)
						{
							...
							if(thread_exit != 1){
								...
								if(frameConut == 1) (*env)->CallStaticVoidMethod(env, objcetClass, methodID_hideLoading);
...
//SDL End------------------------------------------------------------------------------------
					...
					if(packet->size > 4){
						...
						// if(nalu_type == 7 && nalu_type == 8 && nalu_type == 5){
							// ff->dec_buffer_is_keyframe = PJMEDIA_VID_FRM_KEYFRAME;
							// output->bit_info |= PJMEDIA_VID_FRM_KEYFRAME;
						// }
						// else{
							// ff->dec_buffer_is_keyframe = 0;
						// }
